...
import App from "../App";
describe("Hospital route protection",()=>{
  ...
  it("validates facility registration before sending data",()=>{
    location.hash="#/facility-signup";
    render(<App/>);
    fireEvent.click(screen.getByRole("button",{name:"Create Account"}));
    expect(screen.getByText(/Complete all fields/)).toBeInTheDocument();
  });

  it("returns existing facility administrators to sign in",()=>{
    location.hash="#/facility-signup";
    render(<App/>);
